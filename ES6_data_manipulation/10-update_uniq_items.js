...
function updateUniqueItems(groceries) {
  ...
  // Example usage:
  module.exports = { getListStudents, getListStudentIds, getStudentsByLocation, getStudentIdsSum, updateStudentGradeByCity, createInt8TypedArray, setFromArray, hasValuesFromArray, cleanSet, groceriesList, updateUniqueItems };
